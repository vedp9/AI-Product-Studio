...
|---|---|
| **[SymptomSense AI](./07-symptomsense)** | Safety-first symptom triage assistant with red-flag detection, structured Gemini assessments, Pydantic validation, and medical-response safeguards. |
